function renderImportForm(settingName, callback) {
    new Dialog({
        title: "Import",
            ...
            add: {
                ...
                callback: async (html) => {
                    ...
                    if (form && form.data.files[0]) {
                        ...
                        const newData = [...getSetting(settingName), ...res.flat()];
                        await game.settings.set(moduleName, settingName, newData);
            ...
            overwrite: {
                ...
                callback: async (html) => {
                    ...
                    if (form && form.data.files[0]) {
                        ...
                        const cRules = getSetting(settingName).filter((a) => !data.find((b) => b.uuid === a.uuid));
            ...
            rewrite: {
                ...
                callback: async (html) => {
                    ...
                    if (form && form.data.files[0]) {
                        ...
                        const res = await Promise.all(files);
                        await game.settings.set(moduleName, settingName, res.flat());
                        updateActiveRulesForAll()
                        callback.call(this);
                    }
                },
